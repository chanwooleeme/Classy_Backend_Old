...
public class MemberDao {
    ...
    public Optional<Member> findOneByClassyNickName(String nickname) throws SQLException{
        try {
            return Optional.ofNullable(em.createQuery("select m from Member m where m.nickname=?1",Member.class)
                    .setParameter(1,nickname).getSingleResult());
        }
        catch (Exception e){
